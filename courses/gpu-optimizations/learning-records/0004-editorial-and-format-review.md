...
diagnose-then-optimize progression visible. A skip link, clear keyboard focus,
contained overflow, and single-column narrow layout improve access without
adding a runtime dependency to the portable page.
