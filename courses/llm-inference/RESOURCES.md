...
- [AIPerf token, chunk, and completion metric definitions](https://docs.nvidia.com/aiperf/reference/ai-perf-metrics-reference)
...
- [TensorRT-LLM context/generation phases and in-flight batching](https://nvidia.github.io/TensorRT-LLM/advanced/gpt-attention.html)
- [NVIDIA Model Optimizer quantization and export](https://nvidia.github.io/Model-Optimizer/guides/1_quantization.html)
...
- [vLLM preemption and request resumption](https://docs.vllm.ai/en/latest/configuration/optimization/)
- [Transformers custom-model loading and remote-code precautions](https://huggingface.co/docs/transformers/models#custom-models)
