...
TTFT, ITL/TPOT formula, timestamp endpoints, token denominator, percentile
population, request and token throughput, goodput objective,
...
| TTFT, request-average ITL/TPOT, ICL, end-to-end p50/p90/p99, request and output-token throughput | To record | To record |
