# soperator-nfs-server

Optional in-cluster NFS server companion chart for Soperator test and learning
clusters. For production shared storage, prefer Nebius SFS or the VM-based NFS
