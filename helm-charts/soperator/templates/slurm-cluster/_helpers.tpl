...
{{- if regexMatch "(?im)^\\s*DefMemPerCPU\\s*=" $customSlurmConfig -}}
  {{- fail "customSlurmConfig contains DefMemPerCPU, but Soperator 3.0.4 defaults slurmConfig.defMemPerNode=0 and Slurm treats DefMemPerCPU and DefMemPerNode as mutually exclusive. For GPU workers, use DefMemPerGPU with DefCpuPerGPU instead." -}}
{{- end -}}
{{- end -}}
