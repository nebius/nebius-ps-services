...
defaults:
  ...
  # Tunnel Health Monitoring (automatic failure detection and recovery)
  health_monitoring:
    enabled: true                      # Enable automatic health checks
    check_interval_seconds: 60         # Check tunnel health every 60 seconds
    ...
    # - Use proactive mode only if failures occur >3 times/day despite NAT keepalives
    # - See REACTIVE_VS_PROACTIVE_MODES.md for detailed trade-off analysis
