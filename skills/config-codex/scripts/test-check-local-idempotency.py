...
MANAGED_BLOCK = "\n".join(
    [
        ...
        "  system temporary directory first, then submit that resolved absolute",
        "  descendant literally in a scoped non-forced deletion such as",
        "  `find /tmp/<task-owned-tree> -depth -delete`. Never target the",
