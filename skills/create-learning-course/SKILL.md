...
For `$create-learning-course --help` or `$create-learning-course -h` (including native Claude forms), return concise help and stop before
...
Use `$create-learning-course` in Codex, `/create-learning-course` in Claude Code, or
`/skills:create-learning-course` in the Claude plugin. Dollar-prefixed skill examples
