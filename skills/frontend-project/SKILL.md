...
For `$frontend-project --help` or `$frontend-project -h` (including native Claude forms), return concise help and stop before
...
Use `$frontend-project` in Codex, `/frontend-project` in Claude Code, or
`/skills:frontend-project` in the Claude plugin. Dollar-prefixed skill examples
