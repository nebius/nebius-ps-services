...
For `$github-workflows --help` or `$github-workflows -h` (including native Claude forms), return concise help and stop before
...
Use `$github-workflows` in Codex, `/github-workflows` in Claude Code, or
`/skills:github-workflows` in the Claude plugin. Dollar-prefixed skill examples
