...
For `$linter --help` or `$linter -h` (including native Claude forms), return concise help and stop before
...
Use `$linter` in Codex, `/linter` in Claude Code, or
`/skills:linter` in the Claude plugin. Dollar-prefixed skill examples
