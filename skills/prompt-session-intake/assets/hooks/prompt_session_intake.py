...
_load_skill_support('prompt-intake', __file__, 'prompt-session-intake/assets/hooks/prompt_session_intake.py')

from prompt_session_state import PromptSessionError, evaluate_submit  # noqa: E402 — verified bootstrap precedes runtime imports
