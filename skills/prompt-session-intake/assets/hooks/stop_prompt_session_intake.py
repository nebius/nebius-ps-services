...
_load_skill_support('prompt-intake', __file__, 'prompt-session-intake/assets/hooks/stop_prompt_session_intake.py')

from prompt_session_state import (  # noqa: E402 — verified bootstrap precedes runtime imports
    PromptSessionError,
    codex_home,
    evaluate_stop,
