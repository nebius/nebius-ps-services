...
| WORKFLOW_UPGRADE_REQUIRED | Private execution uses unsupported coordinator schema v1, v2, v3, or v4, including a completed record; or an unfinished run lacks its required managed prompt binding. | stop without mutation and start a new coordinator-v5 or prompt-bound run |
