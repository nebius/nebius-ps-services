...
For `$sdlc-create-plan --help` or `$sdlc-create-plan -h` (including native Claude forms), return concise help and stop before
...
Use `$sdlc-create-plan` in Codex, `/sdlc-create-plan` in Claude Code, or
`/skills:sdlc-create-plan` in the Claude plugin. Dollar-prefixed skill examples
