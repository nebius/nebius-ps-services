...
For `$sdlc-create-requirements --help` or `$sdlc-create-requirements -h` (including native Claude forms), return concise help and stop before
...
Use `$sdlc-create-requirements` in Codex, `/sdlc-create-requirements` in Claude Code, or
`/skills:sdlc-create-requirements` in the Claude plugin. Dollar-prefixed skill examples
