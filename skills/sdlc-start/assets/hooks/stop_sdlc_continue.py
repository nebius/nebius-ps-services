...
_load_skill_support('sdlc-hook-state', __file__, 'sdlc-start/assets/hooks/stop_sdlc_continue.py')

from lib.sdlc_policy import continue_with, stop  # noqa: E402 — verified bootstrap precedes runtime imports
