...
Use this contract after accepting a prompt revision and before design or
execution planning. The editable prompt is durable user intent;
`docs/requirements.md` is the compiled product contract.
...
`agentic-sdlc/requirements-refinement-v1`. It records:
...
- the compiled requirements-file digest and update time.
