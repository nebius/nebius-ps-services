...
description: "Use only as part of the Agentic SDLC workflow; after validation, run applicable unit, integration, component, contract, regression, and mock behavior tests for the feature and planned end-to-end slice."
...
For `$sdlc-unit-tests --help` or `$sdlc-unit-tests -h` (including native Claude forms), return concise help and stop before
...
Use `$sdlc-unit-tests` in Codex, `/sdlc-unit-tests` in Claude Code, or
`/skills:sdlc-unit-tests` in the Claude plugin. Dollar-prefixed skill examples
