...
_load_skill_support('runtime', __file__, 'task-implementer-test/scripts/verify_task_implementer.py')

from task_implementer_reporting import build_report, write_private  # noqa: E402 — verified bootstrap precedes runtime imports
from task_implementer_lifecycle import _ensure_root  # noqa: E402 — verified bootstrap precedes runtime imports


from agent_runtime import agent_home, installed_skills_dir  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument(
        "--installed-root",
        type=Path,
        default=installed_skills_dir() / "task-implementer",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=Path,
        default=installed_skills_dir() / "project-agent-instructions",
    )
    parser.add_argument(
