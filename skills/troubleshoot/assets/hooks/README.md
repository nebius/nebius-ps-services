...
- The Stop hook accepts the turn only after the assistant returns the required
  troubleshooting report. It requests the report once and then stops with an
  explicit warning instead of creating an infinite continuation loop.
