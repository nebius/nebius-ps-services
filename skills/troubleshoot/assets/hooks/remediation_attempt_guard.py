...
_load_skill_support('runtime', __file__, 'troubleshoot/assets/hooks/remediation_attempt_guard.py')

from agent_runtime import agent_home, state_edit_only  # noqa: E402
...
def _patch_updates_only_state(payload: dict[str, Any], state_file: Path | None) -> bool:
    ...
    try:
        ...
        return False
    if state_edit_only(payload, state_file):
        return True
